    ...
    void crear() {
        ...
        if (cn.getConectar()) {
            ...
            string insert = "INSERT INTO compras(idcompra,no_orden_compra,idproveedor,fecha_orden,fechaingreso) "
                "VALUES('" + t + "','" + noc + "','" + tt + "','" + fecha_orden + "',  NOW()  )";
        ...
        cn.abrir_conexion();
        if (cn.getConectar()) {
            string a = to_string(id_compra_detalle);
            ...
            string insert = "INSERT INTO compras_detalle(idcompra_detalle,idcompra,idProducto,cantidad,precio_costo_unitario)"
                "VALUES('" + a + "','" + a + "','" + aaa + "','" + c + "','" + aaaa + "')";
            const char* i = insert.c_str();
            q_estado = mysql_query(cn.getConectar(), i);
            if (!q_estado) {
                system("cls");
    ...
    void leer() {
        ...
        if (cn.getConectar()) {
            ...
            if (!q_estado) {
                resultado = mysql_store_result(cn.getConectar());
                while (fila = mysql_fetch_row(resultado)) {
                    cout << "____Compras Detalle____" << endl;
